...
namespace Ecommerce_Apis.OrderModule.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateOrder([FromBody] CreateOrderRequest request, string coupon)
        {
            ...
            try
            {
                var data = await _orderRepositories.CreateOrder(request, userId, coupon);
                response.Data = data;

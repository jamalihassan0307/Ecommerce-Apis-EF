...
namespace Ecommerce_Apis.ProductModule.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        [HttpGet("{parentId}")]
        [AllowAnonymous]
        public async Task<IActionResult> GetProductsByCategory(int parentId, bool parentProducts )
            {
            ResponseDTO response = new();
            try { 
             var data=await _productRepository.FilterProductsCategory(parentId, parentProducts ,_mapper);
        ...
        [HttpGet("{parentId}")]
        [AllowAnonymous]
        public async Task<IActionResult> GetsimilarProducts(int parentId, bool parentProducts)
        {
            ResponseDTO response = new();
            try { 
             var data=await _productRepository.FilterProductsCategory(parentId, parentProducts, _mapper);
